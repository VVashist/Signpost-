...
public class PuzzleGeneratorTests {
    ...
    public void puzzleTest() {
        ...
        puzzler.setSeed(314159);
        model = puzzler.getPuzzle(4, 4, false);
        checkPuzzle(model.solution(), 4, 4, false);
        puzzler.setSeed(314159);
        ...
        model = puzzler.getPuzzle(6, 6, true);
        checkPuzzle(model.solution(), 6, 6, true);
